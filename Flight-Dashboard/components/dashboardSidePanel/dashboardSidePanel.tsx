...
export function DashboardSidePanel({ onRunTests }) {
  ...
  const handleSliderChange = (event: Event, newValue: number | number[]) => {
    ...
    return (
    <>
      <div style={{"width": "100%", "height": "100%","display": "flex", "gap": ".6rem", "flexDirection": "column", "border": "1px solid black", "padding": "10px"}}>
       <div class="group1" style={{ "width": "98%",  "height": "100px", display: "flex", gap: "1rem"}}>
       ...
       <div class="group2" style={{ "width": "98%",  "height": "100px", display: "flex", gap: "1rem" }}>
        <FormControl fullWidth>
        ...
        <FormControl fullWidth>
            <InputLabel id="programming-lang-label">Programming Language</InputLabel>
            <Select
        ...
        <div style={{ display: "flex", gap: ".5rem" }}>
            ...
            <Button variant="contained" color="success" onClick={() => onRunTests()}>Run tests</Button>
            <Button variant="contained" color="success" onClick={() => onRunTests()}>"STAR AI LOGO" Generate tests</Button>
        </div>
    </>
